...
{
    FCLLoginController* vc = [[FCLLoginController alloc] initWithNibName:nil bundle:nil];
    vc.email = email;
    __weak FCLLoginController* wc = vc;
    vc.completionHandler = ^(FCLSession* session, NSError* error) {
